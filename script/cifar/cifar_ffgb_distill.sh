...
python run_ffgd_distill.py --dataset cifar --homo_ratio .1 --n_workers 50 --n_global_rounds 100  --device cuda \
...
python run_ffgd_distill.py --dataset cifar --homo_ratio .3 --n_workers 50 --n_global_rounds 100  --device cuda \
      --dense_hid_dims 120-84 --conv_hid_dims 6-16 --model convnet \
      --n_ray_workers 5 --worker_local_steps 5 --step_size_0 10 --p .9 --oracle_local_steps 2000\
       --device_id 1,2,3,4,5 --backend ray --oracle_step_size 2e-3